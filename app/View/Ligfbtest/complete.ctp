...
<div id="wrapper">
  <nav id="brdNav">
	...
	<article id="main" class="clearfix">
		...
		<div id="stepNav"><img src="../images/common/img_step3.png" width="482" height="65" alt="STEP1.Facebook認証 STEP2.エントリー登録 FINISH.完了"></div>
		<section id="formArea">
			<h1>基本情報登録</h1>
			<p class="compTxt">送信が完了しました。<br>
			ご登録ありがとうございます。</p>
			
			<p class="txt_c last-child"><a href="../index.html">トップページへ戻る</a></p>
